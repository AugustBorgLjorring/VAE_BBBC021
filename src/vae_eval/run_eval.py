...
from tsne          import run_tsne, run_tsne_nn_grid, run_tsne_nn_grid_orig, run_tsne_labeled
from pca           import run_pca_grid, run_pca_nn_grid, run_pca_nn_grid_orig, run_pca_labeled
...
def parse_args():
    ...
    p.add_argument("--sens_n", type=int, default=1000)
